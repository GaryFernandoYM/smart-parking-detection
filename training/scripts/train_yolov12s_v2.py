"""
YOLOv12s — 10 runs con seeds diferentes
"""
import numpy as np
import torch
import json
...
SAVE_DIR  = f"{BASE}/modelos/v2/yolov12s"
SAVE_JSON = f"{BASE}/modelos/v2/yolov12s_full.json"
DEVICE    = "cuda:1"
...
for i, seed in enumerate(SEEDS):
    print(f"\n{'='*60}")
    print(f"YOLOv12s v2 — Run {i+1}/10 (seed={seed})")
    print(f"{'='*60}")
...
with open(SAVE_JSON, "w") as f:
    json.dump({
        "model": "YOLOv12s", "dataset": "Smart Parking UPeU v2",
